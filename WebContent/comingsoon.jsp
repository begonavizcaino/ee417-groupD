...
<!-- ******************************************************************************************* -->
    ...
    <div class="wrapper bgded overlay" style="background-image:url('images/comingsoon.jpg')">
        <section class="hoc container clear"> 
            <div class="sectiontitle center">
                    <h3 class="heading">Coming Soon</h3><br><br><br><br><br>
                    <h2>Please Sign-Up using your e-mail address </h2><br><br><br>
                    <h2><a href="signup.jsp">click here</a> to return to Sign-Up page </h2><br><br><br><br><br><br><br><br>
